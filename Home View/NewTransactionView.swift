                            ...
                            HStack
                                {
                                    ...
                                    if costumeDateView
                                    {
                                        ...
                                        Button(action:
                                            ...
                                            Text("\(String(Calendar.current.component(.year, from: self.date)))/\(Calendar.current.component(.month, from: self.date))/\(Calendar.current.component(.day, from: self.date))")
                                        }
